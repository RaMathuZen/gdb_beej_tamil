...
கொள்ளுங்கள்!)  மேலும் `printf()` வரியில் **next** ஐ இயக்கும்போது, ​​நாம் வெளியீடு(output) தோன்றுவதைப் பார்க்கலாம்.
...
கடைசியில் ` __libc_start_main()` பற்றிய விசித்திரமான விஷயங்கள் காணப்படுகின்றன. அது உங்கள் `main()` செயல்பாடை மற்றொரு செயல்பாடு அழைகப்பதாக காட்டுகிறது!. இது பிழைத்திருத்தத்துடன் தொகுக்கப்படவில்லை,
